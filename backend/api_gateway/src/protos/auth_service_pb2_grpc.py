...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ForgotPassword = channel.unary_unary(
                ...
                request_serializer=auth__service__pb2.ForgotPasswordRequest.SerializeToString,
                response_deserializer=auth__service__pb2.ForgotPasswordResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ForgotPassword': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__service__pb2.ForgotPasswordRequest.FromString,
                    response_serializer=auth__service__pb2.ForgotPasswordResponse.SerializeToString,
            ),
...
class AuthService(object):
    ...
    def ForgotPassword(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.AuthService/ForgotPassword',
            auth__service__pb2.ForgotPasswordRequest.SerializeToString,
            auth__service__pb2.ForgotPasswordResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
