...
logger = get_logger(f"{settings.NOTIFICATION_SERVICE_NAME} - Database")


class DatabaseManager:
    """Manages MongoDB database connections and operations for Notification Service.
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            self.db = self.client[settings.NOTIFICATION_SERVICE_MONGO_DATABASE_NAME]
    ...
    def get_notification_crud(self) -> NotificationCRUD:
        """Get NotificationCRUD instance for notification operations."""
