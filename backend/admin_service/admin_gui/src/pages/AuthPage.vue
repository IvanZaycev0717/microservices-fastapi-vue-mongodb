<template>
  <q-page class="q-pa-lg">
    <div class="row items-center justify-between q-mb-md">
      <div class="col">
        <h2 class="text-h4 q-mb-none">Auth</h2>
        <p class="text-grey-7 q-mt-sm">Manage users and their permissions</p>
      </div>
      <div class="col-auto">
        <q-btn color="primary" icon="add" label="Create User" @click="createModalRef?.open()" />
      </div>
    </div>
    ...
    <CreateUserModal ref="createModalRef" @created="handleUserCreated" />

    <UpdateUserModal ref="updateModalRef" @updated="handleUserUpdated" />
  </q-page>
</template>
