<template>
  <div class="tech-cards">
    ...
    <div v-else-if="techData.length" class="row q-col-gutter-md">
      <div v-for="kingdom in kingdoms" :key="kingdom.key" class="col-12 col-sm-6 col-md-4">
        <q-card class="tech-card">
          <q-card-section>
            <div class="text-h6">{{ kingdom.kingdom }}</div>
            <q-list dense>
              <q-item v-for="(skill, index) in kingdom.items" :key="index" class="skill-item">
                <q-item-section>
